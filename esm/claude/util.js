 ...
 */
export const openaiToClaudeRequest = (messages, orgId, conversationId, sessionKey) => {
 ...
 * ```
 ...
 ```
 */
export const generatePrompt = (messages) => {
...
export async function readerStream(response) {
